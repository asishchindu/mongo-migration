  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('mongo_migration')->notice('New city %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The city %label has been updated.', $message_args));
        $this->logger('mongo_migration')->notice('The city %label has been updated.', $logger_args);
        break;
